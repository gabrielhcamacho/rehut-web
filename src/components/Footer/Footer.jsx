...
export default function Footer() {
  return (
    <footer >
      ...
      <div className="mx-auto container xl:px-20 lg:px-12 sm:px-6 px-4 lg:py-12">
        <div className="flex flex-col items-center justify-center">
          <div>
            <h2 classNameName="text-text">TendenceB.</h2>
          </div>
          <div className="flex flex-wrap sm:gap-10 gap-8 items-center justify-center mt-8">
            <a href="javascript:void(0)" className="focus:underline focus:outline-none hover:text-primary text-base cursor-pointer leading-4 text-text ">
              About
            </a>
            <a href="javascript:void(0)" className="focus:underline focus:outline-none hover:text-primary text-base cursor-pointer leading-4 text-text">
              Contact us
          ...
          <div className="flex items-center gap-x-8 mt-6">
            <button aria-label="facebook" className="focus:ring-offset-2 focus:ring-2 focus:ring-slate-800 focus:outline-none rounded-full ">
              <svg className="fill-current text-slate-800 hover:text-primary" width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <button aria-label="instagram" className="focus:ring-offset-2 focus:ring-2 focus:ring-slate-800 focus:outline-none rounded-full ">
              <svg className="fill-current text-slate-800 hover:text-primary" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <button aria-label="pinterest" className="focus:ring-offset-2 focus:ring-2 focus:ring-slate-800 focus:outline-none rounded-full">
              <svg className="fill-current text-slate-800 hover:text-primary" width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
          ...
          <div className="flex items-center mt-6">
            <p className="text-base leading-4 text-text">2021 <span className="font-semibold text-text">TendenceB.</span></p>
            <div className="border-l border-gray-800 pl-2 ml-2">
              <p className="text-base leading-4 text-text dark:text-gray-400">Inc. All rights reserved</p>
            </div>
          </div>
        </div>
      </div>
